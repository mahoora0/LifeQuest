...
public class GroupService {
    ...
    private GroupResponse response(Group group,Long userId,boolean full){
        ...
        return new GroupResponse(group.getId(),group.getName(),group.getDescription(),group.getVisibility(),group.getMaxMembers(),count,group.getStatus(),group.getOwner().getId(),group.getOwner().getNickname(),mine==null?null:mine.getRole(),mine==null?null:mine.getStatus(),group.getStatus()==GroupStatus.ACTIVE&&count<group.getMaxMembers(),memberItems,recent,group.getCreatedAt(),group.getUpdatedAt());
    }
