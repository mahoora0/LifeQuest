...
public class GroupQuestController {
    ...
    @DeleteMapping("/{questId}/permanent") public ApiResponse<Boolean> deletePermanently(@AuthenticationPrincipal Jwt jwt,@PathVariable Long groupId,@PathVariable Long questId){service.deletePermanently(groupId,uid(jwt),questId);return ApiResponse.success(true);}
