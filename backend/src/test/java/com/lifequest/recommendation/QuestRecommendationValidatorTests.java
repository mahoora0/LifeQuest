...
class QuestRecommendationValidatorTests {
 ...
 private QuestRecommendationCandidate candidate(String title,int cost){return new QuestRecommendationCandidate(0,null,RecommendationType.PLACE,title,"실제로 수행할 수 있는 충분히 긴 설명입니다",RecommendationCategory.CULTURE,120,DurationUnit.MINUTES,cost,"성수동 전시 공간","현장에서 활동을 완료한 뒤 기록하세요");}
}
